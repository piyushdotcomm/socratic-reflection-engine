...
export const ClaudeChatInput: React.FC<ClaudeChatInputProps> = ({ onSendMessage, isLoading, placeholder }) => {
    ...
    return (
        ...
        >
            ...
            <div className={`
                !box-content flex flex-col items-stretch transition-all duration-200 relative z-10 rounded-[1.25rem] cursor-text border border-bg-300 dark:border-transparent 
            ...
            `}>
                ...
                <div className="flex flex-col px-3 pt-3 pb-2 gap-2">
                    ...
                    {/* 2. Action Bar */}
                    <div className="flex gap-2 w-full items-center pl-1">
                        {/* Left Tools */}
                                ...
                                <button
                                    ...
                                    className={`
                                        ...
                                        ${hasContent && !isLoading
                                            ...
                                            : 'bg-accent/30 text-bg-0/60 cursor-not-allowed'}
                                    `}
                                    type="button"
